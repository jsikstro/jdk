...
ZPage* ZAllocatorForRelocation::alloc_page_for_relocation(ZPageType type, size_t size, uint32_t pid, ZAllocationFlags flags) {
  return _object_allocator.alloc_page_for_relocation(type, size, pid, flags);
}
