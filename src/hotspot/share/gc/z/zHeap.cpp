...
ZPage* ZHeap::alloc_page(ZPageType type, size_t size, uint32_t pid, ZAllocationFlags flags, ZPageAge age) {
  ZPage* const page = _page_allocator.alloc_page(type, size, pid, flags, age);
  if (page != nullptr) {
