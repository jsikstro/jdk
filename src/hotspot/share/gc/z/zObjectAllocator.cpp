...
ZPage* ZObjectAllocator::alloc_page_for_relocation(ZPageType type, size_t size, uint32_t pid, ZAllocationFlags flags) {
  return ZHeap::heap()->alloc_page(type, size, pid, flags, _age);
}
