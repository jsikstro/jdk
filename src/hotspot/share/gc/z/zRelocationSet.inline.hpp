...
inline ZRelocationSetNUMAIterator::ZRelocationSetNUMAIterator(ZRelocationSet* relocation_set)
  : ZArrayIteratorImpl<ZForwarding*, true /* Parallel */>(relocation_set->_forwardings, relocation_set->_nforwardings) {}
